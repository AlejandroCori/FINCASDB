                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            T_Vivienda Particular
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered" id="datatablesSimple">
                                <thead>
                                    <tr>
                                        <th scope="col">Cod Vivienda Particular</th>
                                        <th scope="col">N.Habitaciones </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $sql = $Conexion->query("SELECT * FROM ViviendaParticular;");
                                    $Fila = $sql->fetch_all(MYSQLI_ASSOC);

                                    foreach ($Fila as $dato) {
                                    ?>
                                        <tr>
                                            <td><?php echo $dato['codViviendaParticular'] ?> </td>
                                            <td><?php echo $dato['nHabitaciones'] ?> </td>
                                        <?php
                                    }
                                        ?>
                                </tbody>
                            ...
                            <div class="container">
                                    <a href="CRUD/T_VP_A.php" class ="btn btn-success">Agregar</a>
                                    <a href="CRUD/T_VP_M.php" class ="btn btn-warning">Editar</a>
                                    <a href="CRUD/T_VP_E.php" class ="btn btn-danger">Eliminar</a>
                            </div>
                        </div>
                    </div>
                </div>
